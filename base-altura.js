...
function showParallelogramInfo(type) {
    ...
    if (type === 'rectangulo') {
        showElements(['rectBase1', 'rectBaseLabel1', 'rectHeight1', 'rectHeightLabel1']);
        ...
        showElements(['squareBase1', 'squareBaseLabel1', 'squareHeight1', 'squareHeightLabel1']);
        document.getElementById('parallelogramDetails').innerHTML = `
            <h5>🔷 Cuadrado</h5>
        ...
        showElements(['rhombusBase1', 'rhombusBaseLabel1', 'rhombusHeight1', 'rhombusHeightLabel1']);
        document.getElementById('parallelogramDetails').innerHTML = `
            <h5>🔷 Rombo</h5>
            <p><span style="color: var(--error);">Base (roja):</span> 15 cm</p>
...
function checkExercise2() {
    ...
    if (area === 24) {
        result.innerHTML = '<div class="alert alert-success">🎉 ¡Perfecto! Área = 6 × 4 = 24 cm²</div>';
        exercisesCompleted++;
    } else {
        result.innerHTML = '<div class="alert alert-danger">❌ Recuerda: Área = Base × Altura = 6 × 4</div>';
    }
}
...
function checkExercise3() {
    ...
    if (area === 7.5) {
        result.innerHTML = '<div class="alert alert-success">🎉 ¡Excelente! María tiene que pintar 7.5 m² (3 × 2.5 = 7.5)</div>';
        exercisesCompleted++;
    } else {
        result.innerHTML = '<div class="alert alert-danger">❌ Calcula: 3 metros × 2.5 metros</div>';
    }
}
...
function completeLesson() {
    if (exercisesCompleted >= 2) {
        ...
        alert('🎉 ¡Felicidades! Has completado la lección de Base y Altura. ¡Eres un experto en geometría!');
